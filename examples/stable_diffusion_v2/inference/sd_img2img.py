...
from libs.sd_infer import SD_Img2Img
...
def main(args):
    ...
    for i, prompts in enumerate(data):
        ...
        for n in range(args.n_iter):
            ...
            x_samples = sd_infer(tokenized_prompts, tokenized_negative_prompts, img, noise, timesteps)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--prompt", type=str, default="A fantasy landscape, trending on artstation", help="the prompt to render"
    )
    parser.add_argument(
        "--image_path", type=str, default="imgs/sketch-mountains-input.jpg", help="origin imgae path"
    )
