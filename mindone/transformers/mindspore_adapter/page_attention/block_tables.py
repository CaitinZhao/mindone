...
class BlockTables:
    ...
    def init_cache_engine(self, batch_size):
        ...
        logging.info("init cache engine success.")
    ...
    def assemble_pa_full_inputs(self, max_input_length, batch_valid_length: np.array, is_finished: List[bool]):
        ...
        for i in range(bs):
            if not is_finished[i]:
                logging.debug("prepare cache for full: %s", batch_valid_length[i])
    ...
    def assemble_pa_inc_inputs(self, batch_valid_length: np.array, is_finished: List[bool]):
        ...
        for i in range(bs):
            if not is_finished[i]:
                logging.debug("prepare cache for inc: %s", batch_valid_length[i])
    ...
    def clear_cache(self):
        ...
        logging.info("Clear block table cache engines.")
